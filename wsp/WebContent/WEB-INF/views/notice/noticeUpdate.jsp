	...
	<div class="container my-5">
		...
		<h3>공지사항 수정</h3>
	      ...
	      <div class="bg-white rounded shadow-sm container py-3">
	        <form method="POST" action="update.do?no=<%= notice.getNoticeNo()%>" role="form" onsubmit="return validate();">
	          ...
	          <div class="form-inline mb-2">
	            <div class="input-group">
	              ...
	              <h5 class="my-0" id="writer"><%= notice.getMemberId() %></h5>
	            </div>
	          </div>
	          ...
	          <div class="form-inline mb-2">
	            <div class="input-group">
	              ...
	              <h5 class="my-0" id="today"><%= notice.getNoticeModifyDate() %></h5>
	            </div>
	          </div>
       	...
       	<div class="text-center">
					...
					<a href="view.do?no=<%=notice.getNoticeNo() %>" class="btn btn-primary">취소</a>
				</div>
