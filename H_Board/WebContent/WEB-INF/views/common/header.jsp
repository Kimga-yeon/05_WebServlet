<%@page import="com.gy.wsp.member.model.vo.Member"%>
...
<head>
  ...
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css">
	...
	<style>
	 ...
	 <script>
	 	/*** 이전 페이지에서 전달받은 내용을 alert창으로 표시하기 ***/
...
<body>
	...
	<div class="header navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			<a class="navbar-brand" href="<%=request.getContextPath()%>">SEMI PROJECT</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
				  ...
				  <%-- 세션에서 login 정보를 얻어 왔는데 null이었다 == 로그인이 안되어 있을 때 --%>
				  <% if(loginMember == null) {%>
	...
	<div class="modal fade" id="modal-container-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">						<!-- 요청 주소 중 최상위 주소 (/wsp)를 얻어옴 -->
					<form class="form-signin" method="POST" action="<%=request.getContextPath()%>/member/login.do"
						...
						<div class="checkbox mb-3">
							<label> 
								...
								<input type="checkbox" name="saveEmail" <%=isSave ? "checked" : "" %>> 이메일 저장
	...
	<script>
		// 로그인 유효성 검사
		// -> 이메일 , 비밀번호 중 하나라도 입력되지 않으면 form태그 기본 이벤트를 제거한다.
